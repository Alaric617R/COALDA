...
define dso_local void @_Z27rgb_copy_struct_interleavedP5pixelS0_(ptr noundef %0, ptr noundef %1) #0 {
  ...
  %7 = zext i32 %6 to i64
  %8 = getelementptr inbounds %struct.pixel, ptr %5, i64 %7
  %9 = getelementptr inbounds %struct.pixel, ptr %8, i32 0, i32 0
  %10 = load i32, ptr %9, align 4
  %11 = load ptr, ptr %3, align 8
  %12 = call i32 @llvm.nvvm.read.ptx.sreg.tid.x()
  %13 = zext i32 %12 to i64
  %14 = getelementptr inbounds %struct.pixel, ptr %11, i64 %13
  %15 = getelementptr inbounds %struct.pixel, ptr %14, i32 0, i32 0
  store i32 %10, ptr %15, align 4
  %16 = load ptr, ptr %4, align 8
  %17 = call i32 @llvm.nvvm.read.ptx.sreg.tid.x()
  %18 = zext i32 %17 to i64
  %19 = getelementptr inbounds %struct.pixel, ptr %16, i64 %18
  %20 = getelementptr inbounds %struct.pixel, ptr %19, i32 0, i32 1
  %21 = load i32, ptr %20, align 4
  %22 = load ptr, ptr %3, align 8
  %23 = call i32 @llvm.nvvm.read.ptx.sreg.tid.x()
  %24 = zext i32 %23 to i64
  %25 = getelementptr inbounds %struct.pixel, ptr %22, i64 %24
  %26 = getelementptr inbounds %struct.pixel, ptr %25, i32 0, i32 1
  store i32 %21, ptr %26, align 4
  %27 = load ptr, ptr %4, align 8
  %28 = call i32 @llvm.nvvm.read.ptx.sreg.tid.x()
  %29 = zext i32 %28 to i64
  %30 = getelementptr inbounds %struct.pixel, ptr %27, i64 %29
  %31 = getelementptr inbounds %struct.pixel, ptr %30, i32 0, i32 2
  %32 = load i32, ptr %31, align 4
  %33 = load ptr, ptr %3, align 8
  %34 = call i32 @llvm.nvvm.read.ptx.sreg.tid.x()
  %35 = zext i32 %34 to i64
  %36 = getelementptr inbounds %struct.pixel, ptr %33, i64 %35
  %37 = getelementptr inbounds %struct.pixel, ptr %36, i32 0, i32 2
...
define dso_local void @_Z21rgb_copy_struct_wholeP5pixelS0_(ptr noundef %0, ptr noundef %1) #0 {
  ...
  %17 = sext i32 %16 to i64
  %18 = getelementptr inbounds %struct.pixel, ptr %15, i64 %17
