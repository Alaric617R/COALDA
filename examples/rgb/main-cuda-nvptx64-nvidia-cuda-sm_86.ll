...
%struct.__cuda_builtin_blockIdx_t.34 = type { i8 }
%struct.__cuda_builtin_blockDim_t.35 = type { i8 }
%struct.__cuda_builtin_threadIdx_t.36 = type { i8 }

@blockIdx = extern_weak dso_local addrspace(1) global %struct.__cuda_builtin_blockIdx_t.34, align 1
@blockDim = extern_weak dso_local addrspace(1) global %struct.__cuda_builtin_blockDim_t.35, align 1
@threadIdx = extern_weak dso_local addrspace(1) global %struct.__cuda_builtin_threadIdx_t.36, align 1
