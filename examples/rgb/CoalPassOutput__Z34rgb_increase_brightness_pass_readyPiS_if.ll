...
BB_0:
  ...
  %"offset$0TimesBlockDim" = mul i32 0, %BlockDim
  %valLoadNewOffsetWithOffset1 = add i32 %"GlobalTIDScaled#3", %"offset$0TimesBlockDim"
  %24 = getelementptr inbounds i32, ptr %19, i32 %valLoadNewOffsetWithOffset1
  %25 = load i32, ptr %24, align 4
  %26 = load i32, ptr %15, align 4
  %27 = mul nsw i32 3, %26
  %28 = add nsw i32 %27, 0
  %29 = sext i32 %28 to i64
  %"offset$0TimesBlockDimForStore" = mul i32 0, %BlockDim
  %storePtrGEPNewOffset1 = add i32 %"offset$0TimesBlockDimForStore", %LocalTid
  %30 = getelementptr inbounds [1536 x i32], ptr addrspacecast (ptr addrspace(3) @_ZZ34rgb_increase_brightness_pass_readyPiS_ifE14pixel_smem_src to ptr), i64 0, i32 %storePtrGEPNewOffset1
  ...
  %"offset$1TimesBlockDim" = mul i32 1, %BlockDim
  %valLoadNewOffsetWithOffset2 = add i32 %"GlobalTIDScaled#3", %"offset$1TimesBlockDim"
  %36 = getelementptr inbounds i32, ptr %31, i32 %valLoadNewOffsetWithOffset2
  %37 = load i32, ptr %36, align 4
  %38 = load i32, ptr %15, align 4
  %39 = mul nsw i32 3, %38
  %40 = add nsw i32 %39, 1
  %41 = sext i32 %40 to i64
  %"offset$1TimesBlockDimForStore" = mul i32 1, %BlockDim
  %storePtrGEPNewOffset2 = add i32 %"offset$1TimesBlockDimForStore", %LocalTid
  %42 = getelementptr inbounds [1536 x i32], ptr addrspacecast (ptr addrspace(3) @_ZZ34rgb_increase_brightness_pass_readyPiS_ifE14pixel_smem_src to ptr), i64 0, i32 %storePtrGEPNewOffset2
  ...
  %"offset$2TimesBlockDim" = mul i32 2, %BlockDim
  %valLoadNewOffsetWithOffset3 = add i32 %"GlobalTIDScaled#3", %"offset$2TimesBlockDim"
  %48 = getelementptr inbounds i32, ptr %43, i32 %valLoadNewOffsetWithOffset3
  %49 = load i32, ptr %48, align 4
  %50 = load i32, ptr %15, align 4
  %51 = mul nsw i32 3, %50
  %52 = add nsw i32 %51, 2
  %53 = sext i32 %52 to i64
  %"offset$2TimesBlockDimForStore" = mul i32 2, %BlockDim
  %storePtrGEPNewOffset3 = add i32 %"offset$2TimesBlockDimForStore", %LocalTid
  %54 = getelementptr inbounds [1536 x i32], ptr addrspacecast (ptr addrspace(3) @_ZZ34rgb_increase_brightness_pass_readyPiS_ifE14pixel_smem_src to ptr), i64 0, i32 %storePtrGEPNewOffset3
  ...
  %"offset$0TimesBlockDim1" = mul i32 0, %BlockDim
  %valLoadNewOffsetWithOffset12 = add i32 %LocalTid, %"offset$0TimesBlockDim1"
  %116 = getelementptr inbounds [1536 x i32], ptr addrspacecast (ptr addrspace(3) @_ZZ34rgb_increase_brightness_pass_readyPiS_ifE14pixel_smem_dst to ptr), i64 0, i32 %valLoadNewOffsetWithOffset12
  ...
  %"offset$0TimesBlockDimForStore3" = mul i32 0, %BlockDim
  %storePtrGEPNewOffset14 = add i32 %"offset$0TimesBlockDimForStore3", %"GlobalTIDScaled#3"
  %123 = getelementptr inbounds i32, ptr %118, i32 %storePtrGEPNewOffset14
  ...
  %"offset$1TimesBlockDim5" = mul i32 1, %BlockDim
  %valLoadNewOffsetWithOffset26 = add i32 %LocalTid, %"offset$1TimesBlockDim5"
  %128 = getelementptr inbounds [1536 x i32], ptr addrspacecast (ptr addrspace(3) @_ZZ34rgb_increase_brightness_pass_readyPiS_ifE14pixel_smem_dst to ptr), i64 0, i32 %valLoadNewOffsetWithOffset26
  ...
  %"offset$1TimesBlockDimForStore7" = mul i32 1, %BlockDim
  %storePtrGEPNewOffset28 = add i32 %"offset$1TimesBlockDimForStore7", %"GlobalTIDScaled#3"
  %135 = getelementptr inbounds i32, ptr %130, i32 %storePtrGEPNewOffset28
  ...
  %"offset$2TimesBlockDim9" = mul i32 2, %BlockDim
  %valLoadNewOffsetWithOffset310 = add i32 %LocalTid, %"offset$2TimesBlockDim9"
  %140 = getelementptr inbounds [1536 x i32], ptr addrspacecast (ptr addrspace(3) @_ZZ34rgb_increase_brightness_pass_readyPiS_ifE14pixel_smem_dst to ptr), i64 0, i32 %valLoadNewOffsetWithOffset310
  ...
  %"offset$2TimesBlockDimForStore11" = mul i32 2, %BlockDim
  %storePtrGEPNewOffset312 = add i32 %"offset$2TimesBlockDimForStore11", %"GlobalTIDScaled#3"
  %147 = getelementptr inbounds i32, ptr %142, i32 %storePtrGEPNewOffset312
