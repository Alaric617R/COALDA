...
%struct.__cuda_builtin_threadIdx_t.2 = type { i8 }
%struct.__cuda_builtin_blockDim_t.3 = type { i8 }
%struct.pixel.4 = type { i32, i32, i32 }

@threadIdx = extern_weak dso_local addrspace(1) global %struct.__cuda_builtin_threadIdx_t.2, align 1
@blockDim = extern_weak dso_local addrspace(1) global %struct.__cuda_builtin_blockDim_t.3, align 1

; Function Attrs: convergent mustprogress noinline norecurse nounwind
define dso_local void @_Z20rgb_copy_interleavedP5pixelS0_(ptr noundef %0, ptr noundef %1) #0 {
...
; Function Attrs: convergent mustprogress noinline norecurse nounwind
define dso_local void @_Z18rgb_copy_coalescedP5pixelS0_(ptr noundef %0, ptr noundef %1) #0 {
  %3 = alloca ptr, align 8
  %4 = alloca ptr, align 8
...
!4 = !{ptr @_Z20rgb_copy_interleavedP5pixelS0_, !"kernel", i32 1}
!5 = !{ptr @_Z18rgb_copy_coalescedP5pixelS0_, !"kernel", i32 1}
