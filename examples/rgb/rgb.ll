...
%struct.__cuda_builtin_blockIdx_t.0 = type { i8 }
%struct.__cuda_builtin_blockDim_t.1 = type { i8 }
%struct.__cuda_builtin_threadIdx_t.2 = type { i8 }

@blockIdx = extern_weak dso_local addrspace(1) global %struct.__cuda_builtin_blockIdx_t.0, align 1
@blockDim = extern_weak dso_local addrspace(1) global %struct.__cuda_builtin_blockDim_t.1, align 1
